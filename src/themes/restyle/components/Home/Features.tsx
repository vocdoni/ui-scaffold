  ...
  return (
    <Box id='features' className='site-wrapper' py={{ base: '60px', lg: '100px' }}>
      <Box mb='40px'>
        ...
        <Text fontWeight='bold' fontSize='40px' lineHeight='48px' mb='10px' mr={2}>
          ...
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text display='inline'>{t('home.features.card_1.description')}</Text>
              </Box>
            </CardBody>
          </Card>
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text display='inline'>{t('home.features.card_2.description')}</Text>
              </Box>
            </CardBody>
          </Card>
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text display='inline'>{t('home.features.card_3.description')}</Text>
              </Box>
            </CardBody>
          </Card>
        </Flex>
          ...
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text display='inline'>{t('home.features.card_4.description')}</Text>
              </Box>
            </CardBody>
          </Card>
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text display='inline'>{t('home.features.card_5.description')}</Text>
              </Box>
            </CardBody>
          </Card>
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text display='inline'>{t('home.features.card_6.description')}</Text>
              </Box>
            </CardBody>
          </Card>
        </Flex>
          ...
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text display='inline'>{t('home.features.card_7.description')}</Text>
              </Box>
            </CardBody>
          </Card>
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text display='inline'>{t('home.features.card_8.description')}</Text>
              </Box>
            </CardBody>
          </Card>
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text display='inline'>{t('home.features.card_9.description')}</Text>
              </Box>
            </CardBody>
          </Card>
        </Flex>
