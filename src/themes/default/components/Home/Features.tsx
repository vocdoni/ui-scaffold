  ...
  return (
    <Box id='features' className='site-wrapper' py={{ base: '60px', lg: '100px' }}>
      ...
      <Flex
        ...
        margin='0px auto'
      >
        <Flex flexDirection='column' gap={{ base: '65px', lg: '115px' }} flex='1 1 30%' mb='65px'>
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text fontSize='22px'>{t('home.features.card_1.description')}</Text>
              </Box>
            </CardBody>
          </Card>
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text fontSize='22px'>{t('home.features.card_2.description')}</Text>
              </Box>
            </CardBody>
          </Card>
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text fontSize='22px'>{t('home.features.card_3.description')}</Text>
              </Box>
            </CardBody>
          </Card>
        </Flex>
          ...
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text fontSize='22px'>{t('home.features.card_4.description')}</Text>
              </Box>
            </CardBody>
          </Card>
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text fontSize='22px'>{t('home.features.card_5.description')}</Text>
              </Box>
            </CardBody>
          </Card>
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text fontSize='22px'>{t('home.features.card_6.description')}</Text>
              </Box>
            </CardBody>
          </Card>
        </Flex>
          ...
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text fontSize='22px'>{t('home.features.card_7.description')}</Text>
              </Box>
            </CardBody>
          </Card>
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text fontSize='22px'>{t('home.features.card_8.description')}</Text>
              </Box>
            </CardBody>
          </Card>
          <Card variant='icon-card'>
            <CardBody>
              ...
              <Box>
                ...
                <Text fontSize='22px'>{t('home.features.card_9.description')}</Text>
              </Box>
            </CardBody>
          </Card>
        </Flex>
