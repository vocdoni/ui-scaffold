    ...
    >
      ...
      <Box mb={5}>
        ...
        <List spacing={2}>
          <ListItem>
            <Text>
              <strong>1.1</strong> Vocdoni may collect user personal data such as name, organization name, size, type
              and email addresses when provided as the organization's contact email, though using personal email
              addresses for this purpose is not recommended.
            </Text>
          </ListItem>
          <ListItem>
            <Text>
          ...
          <ListItem>
            <Text>
              <strong>1.3</strong> Additional personal information may be collected and processed as necessary to
              deliver services, fulfill contractual obligations, or comply with legal requirements.
            </Text>
          </ListItem>
        </List>
      </Box>
      ...
      <Box mb={5}>
        ...
        <Text>
          Vocdoni processes personal information provided directly by users through various means, including
          registration on any Vocdoni website, service procurement, or communications.
        </Text>
      </Box>
      ...
      <Box mb={5}>
        ...
        <Text>
          The collected information is used to provide and manage services, conduct marketing and business activities,
          and support customer service and marketing efforts.
        </Text>
      </Box>
