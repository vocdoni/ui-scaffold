...
const Terms = () => {
  return (
    ...
    >
      ...
      <UnorderedList>
        <ListItem>
          <strong>Purpose Limitation:</strong> Personal data is processed solely for providing and improving our
          services or fulfilling legal obligations. We do not process personal data for unrelated purposes.
        </ListItem>
        <ListItem>
      ...
      <UnorderedList>
        <ListItem>
          <strong>Third-Party Disclosure:</strong> Personal data is not shared with third parties except where required
          by law, for providing services (e.g., secure storage or customer support), or with the user's explicit
          consent.
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          <strong>Cross-Border Transfers:</strong> Any cross-border data transfers include adequate protection measures
      ...
      <Text>
        The Vocdoni Association employs strong security measures to protect personal data. Only authorized personnel
        have access to user data, and they are obligated to handle it confidentially.
      </Text>
      <Text>
      ...
      <Text>
        The Vocdoni Association is not responsible for information submitted by end-users or organizers. Voting
        organizers must comply with applicable data protection laws.
      </Text>
