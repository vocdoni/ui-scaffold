...
export type PricingModalType = 'tierUpgrade' | 'planUpgrade' | 'subscription' | 'subscriptionPayment' | 'subscriptionReturn' | null

export type PricingModalContextState = {
  openModal: (type: PricingModalType, modalData?: PlanUpgradeData | TierUpgradeData | SubscriptionPaymentData | null) => void
  closeModal: () => void
