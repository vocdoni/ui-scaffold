            ...
            <CardBody>
              ...
              <Box>
                {areEqualHexStrings(account?.address, organization?.address) ? (
                  <>
                    <Text fontFamily='pixeloid'>{t('organization.elections_list_empty.title')}</Text>
                    ...
                    <Link as={ReactRouterLink} to='/processes/create' variant='onvote-primary' colorScheme='primary'>
                      {t('menu.create')}
                    </Link>
                  </>
                ) : (
