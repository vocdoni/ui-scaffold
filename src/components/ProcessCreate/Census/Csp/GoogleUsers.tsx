...
import { EmailAddressesSpreadsheetManager } from '../Spreadsheet/EmailAddressesSpreadsheetManager'

const GoogleUsers = ({ ...props }) => {
  ...
  const onDrop = async ([file]: File[]) => {
    try {
      ...
      const spreadsheet = new EmailAddressesSpreadsheetManager(file, false)
