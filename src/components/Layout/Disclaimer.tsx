    ...
    >
      ...
      <ModalContent>
        ...
        <ModalBody pb={6}>
          <Stack gap={3}>
            <p>
              This is a DEMO frontend build for showcase purposes. All the data in this homepage are placeholders. You
              can navigate and create elections, to better understand how to use the Vocdoni tech stack.
            </p>
            <p>Buildi with ❤️ by Vocdoni using: </p>
            <p>
              ...
              allowing developers to easily style everything as desired, and to chose from a variety of different voting
              flow components.
            </p>
            <p>
